...
public class SentenceDetector {
    public static void main(String[] args) {
        try {
            new SentenceDetector().trainSentDectectModel();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    /**
     * This method generates a custom model file for sentence detection, in directory "custom_models".
    ...
    public void trainSentDectectModel() throws IOException {
        // directory to save the model file that is to be generated
        File destDir = new File("custom_models"); 
 
        // Allows repeated reads through a stream for model building
        ...
        // saves the model, to a file, "en-sent-custom.bin", in the destDir : "custom_models"
        ...
        // detects sentences in the test string
